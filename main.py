...
def start(bot, update):
    ...
    sleep(0.3)
    bot.sendMessage(chat_id=update.message.chat_id,text='OMG!! Im working look I can say heyy im omkar')

def hello(bot, update):
    bot.sendChatAction(chat_id=update.message.chat_id, action=ChatAction.TYPING)
    sleep(0.3)
    bot.sendMessage(chat_id=update.message.chat_id,text='H@ll~~!! I will kill you')
#def help(bot, update):
    #bot.sendChatAction(chat_id=update.message.chat_id, action=ChatAction.TYPING)
    #sleep(0.3)
...
updater = Updater('448097907:AAFt-I1seXFQccixXQqgDQq4Dch4i0gLg48')
